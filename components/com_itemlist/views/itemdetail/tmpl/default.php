...
<div class="container mx-auto px-4 py-6 flex flex-col mb-18">
    <div class="flex flex-wrap lg:flex-nowrap items-stretch bg-white rounded-lg shadow-lg overflow-hidden mb-18">
        ...
        <div class="w-full lg:w-2/3 p-6 flex flex-col justify-between">
            ...
            <!-- Increased space and font size to fit the description better -->
            <p class="text-gray-700 text-base leading-relaxed mb-6" style="max-height: 400px; overflow-y:auto;">
