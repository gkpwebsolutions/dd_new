...
<body class="bg-gray-50 py-12">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="flex justify-center items-center h-full">
      <img src="images/c8e6476f-575e-4463-9459-e8bc6dbd2961.jpg" alt="Our Instruments" class="rounded-lg shadow-lg w-full object-cover h-full">
    </div>
    ...
    <div class="flex flex-wrap justify-between w-full gap-4">
      ...
      <!-- List of Instruments -->
      <ul class="flex flex-col md:flex-row md:flex-wrap space-y-4 md:space-y-0 md:space-x-4 text-gray-700 text-sm">
        <li class="flex items-center hover:bg-indigo-100 hover:text-indigo-700 hover:scale-105 hover:shadow-lg p-3 rounded-md transition duration-300 ease-in-out">
