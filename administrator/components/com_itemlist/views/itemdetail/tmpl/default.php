...
<div class="w-full relative" style="height: 250px;"> <!-- Container with fixed height -->
    ...
    <div class="absolute inset-0 flex items-center justify-between p-6">
        ...
        <div>
            ...
            <h6 class="text-blue-800 text-xl font-semibold">
                Get Maximum Discount</h6>
</div>


        <div class="text-right flex flex-col items-end"> <!-- Flexbox for vertical alignment -->
...
<h2 class="h5 mb-2 m-text" style="color:#000;">100% ACCURATE REPORT</h2>
    ...
    <div class="flex flex-wrap lg:flex-nowrap items-stretch bg-white rounded-md shadow-md overflow-hidden mb-18">
        ...
        <div class="w-full lg:w-2/3 p-3 flex flex-col justify-between">
            ...
            <!-- Benefits Section with Darker Line -->




            <hr class="border-t-4 border-blue-800 mb-6"> <!-- Lighter Blue Line -->
            ...
            <div class="mb-6">
                ...
                <hr class="border-t-4 border-green-700 mb-6"> <!-- Dark Green Line -->
            ...
            <hr class="border-t-4 border-indigo-800 mb-18"> <!-- Dark Gray Line -->
            ...
            <hr class="border-t-4 border-indigo-800 mt-18 mb-18"> <!-- Dark Gray Line -->
    ...
    <div class="w-full bg-white rounded-md shadow-md p-6 mb-18">
        ...
        <div class="flex items-center justify-start w-full">
            ...
            <!-- Add space between the Offer Price and Buy Now Button -->




            <div class="ml-96 flex items-center"> <!-- Increased margin-left -->
